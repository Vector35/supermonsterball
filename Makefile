...
common/request.pb.o: common/request.pb.cc
...
game_server: $(COMMON_OBJS) $(SERVER_OBJS) game_server.o common/request.pb.o Makefile
	g++ $(CFLAGS) $(LDFLAGS) -std=c++11 -o $@ $(COMMON_OBJS) $(SERVER_OBJS) game_server.o common/request.pb.o -lprotobuf -lssl -lcrypto

standalone: $(COMMON_OBJS) $(CLIENT_OBJS) $(SERVER_OBJS) standalone.o
	g++ $(CFLAGS) $(LDFLAGS) -std=c++11 -o $@ $(COMMON_OBJS) $(CLIENT_OBJS) $(SERVER_OBJS) standalone.o common/request.pb.o -lprotobuf -lssl -lcrypto
